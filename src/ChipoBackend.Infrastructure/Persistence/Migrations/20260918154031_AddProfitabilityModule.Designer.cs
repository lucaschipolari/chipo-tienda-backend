...
namespace ChipoBackend.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260918154031_AddProfitabilityModule")]
    partial class AddProfitabilityModule
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ChipoBackend.Domain.Entities.Analytics.AnalyticsEvent", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("ChipoBackend.Domain.Entities.Catalog.ProductCostHistory", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("VariantId", "RecordedAt");

                    b.ToTable("product_cost_history", "catalog");
                });
            ...
            modelBuilder.Entity("ChipoBackend.Domain.Entities.Combos.Combo", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("ChipoBackend.Domain.Entities.Combos.ComboItem", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("ChipoBackend.Domain.Entities.Catalog.ProductCostHistory", b =>
                {
                    b.OwnsOne("ChipoBackend.Domain.ValueObjects.Money", "UnitCost", b1 =>
                        {
                            b1.Property<Guid>("ProductCostHistoryId")
                                .HasColumnType("uuid");
                            ...
                            b1.HasKey("ProductCostHistoryId");

                            b1.ToTable("product_cost_history", "catalog");

                            b1.WithOwner()
                                .HasForeignKey("ProductCostHistoryId");
                        });
            ...
            modelBuilder.Entity("ChipoBackend.Domain.Entities.Combos.ComboItem", b =>
                {
                    b.HasOne("ChipoBackend.Domain.Entities.Combos.Combo", null)
                        .WithMany("Items")
                        .HasForeignKey("ComboId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
